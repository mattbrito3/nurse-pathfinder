...
BEGIN
    ...
    -- EXPANSÃO: NOVOS FLASHCARDS MÉDICOS/ENFERMAGEM (70+ adicionais)
    
    -- Farmacologia (expandido)
    ...
    (farmacologia_id, 'Interação perigosa: Varfarina + AAS', 'AAS (aspirina) - aumenta risco de sangramento', 3, true, ARRAY['varfarina', 'interação', 'sangramento']),
